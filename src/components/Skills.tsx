...
const skills = [
  ...
  { icon: <Server className="h-8 w-8 text-primary" />, name: 'Ansible' },
  { icon: <Workflow className="h-8 w-8 text-primary" />, name: 'CI/CD' },
  { icon: <Code className="h-8 w-8 text-primary" />, name: 'Scripting' },
